...
if (args[5] != "verbose")
var LAG = args[5] || 4000;//ATENCIO!! LAG el considerem com el LOAD del WORKER
else var LAG = 4000;
//--------------------------------------------
...
if (verbose) console.log('Worker (%s) type %s has sent its first connection message: "%s"', myID, classID, connText); 
...
/**
 ...
 node myworkerB_vp tcp://localhost:8060 WORKER3 Ready vBEEEE B 10000
**/